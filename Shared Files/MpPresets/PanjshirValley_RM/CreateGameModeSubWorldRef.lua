Events:Subscribe('Partition:Loaded', function(partition)
    ...
    ResourceManager:RegisterInstanceLoadHandler(Guid('8683F4BB-CD57-11DF-A251-CAB801F86363'), Guid('3EB89F77-C414-4007-AEC0-6E83641924A2'), function(instance)

        --print('Damavand CQL SubWorldReferenceObjectData ready...')
        local damavandCqlSubWorldReferenceObjectData = SubWorldReferenceObjectData(instance)
