function FirestormCqlCreateVehicle(blueprint, pos, newGuid, indexInBlueprint, teamId, lockedToTeam)
    ...
    local firestormCqlSubWorldData = SubWorldData(ResourceManager:FindInstanceByGuid(Guid('8DB9CB2A-2A16-44B8-927D-024F1AD06FCF'), Guid('252D6BEC-B56C-488F-85AB-5FD3E14EC949')))
